...
const Footer = () => {
  return (
    <footer className="px-6 md:px-40 bg-custom_white pt-5 shadow-2xl">
        ...
        <div className="flex flex-col">
          <Link href="/">
            <Image
              ...
              priority={true}
              quality={100}
              sizes="(min-width: 200px) 120px,(min-width: 780px) 128px, (min-width: 680px) calc(32.5vw - 119px), calc(100vw - 568px)"
      ...
      {/* copyrights */}
      <div className="flex items-center md:justify-between pb-3">
